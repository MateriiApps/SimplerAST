...
object MarkdownRules {
    ...
    open class HeaderLineRule<RC, S>(
        pattern: Pattern = PATTERN_HEADER_ITEM_ALT,
     ...
     */
    open class HeaderLineClassedRule<RC, S>(
        styleSpanProvider: (Int) -> Any,
        ...
        constructor(
            ...
            styleSpanProvider, classSpanProvider,
